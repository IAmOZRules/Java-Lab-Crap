...
class SummerVacation implements Vacation{
    ...
    // Objects for Vacation class
    String Place;
    String Date;
    String[] Activities;
    int[] Cost;

    // Objects for SummerVacation Class
    String CourseTitle;
